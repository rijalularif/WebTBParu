 ...
 */
        ...
        function (t) {
            ...
            function n(t) {
                return window.ShadowDOMPolyfill && window
                    .ShadowDOMPolyfill
                    .wrapIfNeeded(t) || t
            }
            function i() {
                    ...
                    handleEvent: function (t) {
                        switch (t.stopImmediatePropagation(), t.type) {
                            case "DOMAttrModified":
                                ...
                                var s = t.attrChange === MutationEvent.ADDITION
                                    ? null
                                    : t.prevValue;
                                r(i, function (t) {
                                    return !t.attributes || t.attributeFilter && t.attributeFilter.length && -1 === t
                                        .attributeFilter
                                        .indexOf(e) && -1 === t
                                        .attributeFilter
                                        .indexOf(n)
        ...
        function () {
            ...
            if ((!window.CustomEvent || i && "function" != typeof window.CustomEvent) && (
        ...
        function (t) {
            ...
            t.useNative = !e.register && t.hasNative && !window.ShadowDOMPolyfill && (
        ...
        window.CustomElements.addModule(function (t) {
            ...
            function m(t) {
                t = window.wrap(t),
                y.dom && console.group("upgradeDocument: ", t.baseURI.split("/").pop());
            ...
            t.hasPolyfillMutations = C,
            t.hasThrottledAttached = C;
            var x = !1,
                w = [],
                E = Array
                    .prototype
        ...
        window.CustomElements.addModule(function (t) {
            function e(e, i) {
                if (
                    "template" === e.localName && window.HTMLTemplateElement && HTMLTemplateElement.decorate && HTMLTemplateElement.decorate(e),
            ...
            function n(e, n, o) {
                return s.upgrade && console.group("upgrade:", e.localName),
        ...
        window.CustomElements.addModule(function (t) {
            function e(e, i) {
                ...
                if (e.indexOf("-") < 0) 
                    throw new Error(
                        "document.registerElement: first argument ('name') must contain a dash ('-'). A" +
                        "rgument provided was '" + String(e) + "'."
                    );
                if (o(e)) 
                    throw new Error(
                        "Failed to execute 'registerElement' on 'Document': Registration failed for typ" +
                        "e '" + String(e) + "'. The type name is invalid."
                    );
                if (c(e)) 
                    throw new Error(
                        "DuplicateDefinitionError: a type with name '" + String(e) + "' is already regi" +
                        "stered"
                    );
            ...
            function i(t, e, n) {
                ...
                this.attributeChangedCallback && o !== i && this.attributeChangedCallback(
                    t,
                    i,
                    o
                )
        ...
        function (t) {
            ...
            if (
                ...
                var a = window.HTMLImports && !window.HTMLImports.ready
                    ? "HTMLImportsLoaded"
                    : "DOMContentLoaded";
                ...
                browser: {
                    ...
                    supportsInputEvents: function () {
                        ...
                        if ("undefined" == typeof InputEvent) 
                            return !1;
                        for (i = [
                            "data", "getTargetRanges", "inputType"
                        ], t = 0, e = i.length; e > t; t++) 
                            if (n = i[t], !(n in InputEvent.prototype)) 
                                return !1;
                    return !0
                    }()
                },
    ...
    (function () {
                ...
                i.prototype.inspect = function () {
                    ...
                    return t = function () {
                        var t,
                            i,
                            o;
                        i = null != (t = this.contentsForInspection())
                            ? t
                            : {},
                        o = [];
                        for (e in i) 
        ...
        function () {
            ...
            e.extend({
                ...
                squishBreakableWhitespace: function (t) {
                    return t
                        .replace(RegExp("" + e.breakableWhitespacePattern.source, "g"), " ")
                        .replace(/\ {2,}/g, " ")
                },
                    ...
                    : (
                        ...
                        s = a
                            ? (
                                u = r.offset,
                                r,
                                o = n.codepoints.slice(0, u).concat(n.codepoints.slice(u + a)),
            ...
            e.extend({
                arraysAreEqual: function (t, e) {
                    var n,
                        ...
                        o,
                        r;
                    if (null == t && (t = []), null == e && (e = []), t.length !== e.length) 
                        return !1;
        ...
        function () {
            ...
            e.extend({
                handleEvent: function (n, i) {
                    ...
                    s = function (t) {
                        var n;
                        return null != d && 0 === --d && s.destroy(),
                        n = e.findClosestElementFromNode(t.target, {matchingSelector: p}),
                ...
                findClosestElementFromNode: function (t, n) {
                    ...
                    for (
                        ...
                        r = o.untilNode; null != t && t.nodeType !== Node.ELEMENT_NODE;
                    ) 
                        t = t.parentNode;
                    if (null != t) {
                        if (null == i) 
                        ...
                        if (t.closest && null == r) 
                            return t.closest(i);
                        for (; t && t !== r;) {
                            if (e.elementMatchesSelector(t, i)) 
                                return t;
                            t = t.parentNode
                        }
                    }
                ...
                innerElementIsActive: function (t) {
                    return document.activeElement !== t && e.elementContainsNode(
                        t,
                ...
                findElementFromContainerAndOffset: function (t, n) {
                    var i;
                    return i = e.findNodeFromContainerAndOffset(t, n),
                ...
                makeElement: function (t, e) {
                    ...
                    if (e.className) 
                        for (d = e.className.split(" "), r = 0, u = d.length; u > r; r++) 
                            i = d[r],
                            o
                                .classList
                                .add(i);
                    if (e.textContent && (o.textContent = e.textContent), e.childNodes) 
                        for (f = [].concat(e.childNodes), s = 0, c = f.length; c > s; s++) 
                            n = f[s],
                            o.appendChild(n);
                return o
                },
                ...
                nodeIsBlockStart: function (t, n) {
                    ...
                    i
                        ...
                        : e.nodeIsBlockStartComment(t) || !e.nodeIsBlockStartComment(t.firstChild) && e.nodeProbablyIsBlockContainer(
                            t
                        )
                },
                nodeIsBlockStartComment: function (t) {
                    return e.nodeIsCommentNode(t) && "block" === (
                        null != t
                            ? t.data
                            : void 0
                    )
        ...
        function () {
            ...
            i = function (e) {
                ...
                document
                    .head
                    .insertBefore(n, document.head.firstChild),
                n
            },
            t = function () {
                var t;
            ...
            a = function () {
                ...
                window.customElements
                    ? function (e) {
                        ...
                        i = s.disconnect,
                        o && (r = n, n = function () {
                            return this.initialized || (this.initialized = !0, o.call(this)),
                            null != r
                                ? r.call(this)
                                : void 0
                        }),
            ...
            r = function () {
                return window.customElements
                    ...
                    : function (t, e) {
                        var n,
                            i;
                        return i = Object.create(HTMLElement.prototype, e),
            ...
            e.extend({
                dataTransferIsPlainText: function (t) {
                    var e,
                        n,
                        i;
                    return i = t.getData("text/plain"),
                    n = t.getData("text/html"),
                    i && n
                        ? (
                            e = (new DOMParser).parseFromString(n, "text/html").body,
                            e.textContent === i
                                ? !e.querySelector("*")
                                : void 0
                        )
        ...
        function () {
            ...
            e.Operation = function (e) {
                ...
                n.prototype.release = function () {
                    var t;
                    return null != (t = this.promise) && "function" == typeof t.cancel && t.cancel(),
                    this.promise = null,
        ...
        function () {
            ...
            e.UTF16String = function (t) {
                ...
                e.prototype.slice = function () {
                    ...
                    return this
                        .constructor
                        .fromCodepoints((t = this.codepoints).slice.apply(t, arguments))
                },
                ...
                href: {
                    ...
                    parser: function (t) {
                        var n,
                            i,
                            o;
                        return n = e.AttachmentView.attachmentSelector,
                        o = "a:not(" + n + ")",
        ...
        function () {
            ...
            e.config.toolbar = {
                getDefaultHTML: function () {
                    return '<div class="trix-button-row">\n  <span class="trix-button-group trix-button-gr' +
                            'oup--text-tools" data-trix-button-group="text-tools">\n    <button type="butto' +
                            'n" class="trix-button trix-button--icon trix-button--icon-bold" data-trix-attr' +
                            'ibute="bold" data-trix-key="b" title="' + t.bold + '" tabindex="-1">' + t.bold +
                            '</button>\n    <button type="button" class="trix-button trix-button--icon trix' +
                            '-button--icon-italic" data-trix-attribute="italic" data-trix-key="i" title="' +
                            t.italic + '" tabindex="-1">' + t.italic + '</button>\n    <button type="button' +
                            '" class="trix-button trix-button--icon trix-button--icon-strike" data-trix-att' +
                            'ribute="strike" title="' + t.strike + '" tabindex="-1">' + t.strike + '</butto' +
                            'n>\n    <button type="button" class="trix-button trix-button--icon trix-button' +
                            '--icon-link" data-trix-attribute="href" data-trix-action="link" data-trix-key=' +
                            '"k" title="' + t.link + '" tabindex="-1">' + t.link + '</button>\n  </span>\n' +
                            '\n  <span class="trix-button-group trix-button-group--block-tools" data-trix-b' +
                            'utton-group="block-tools">\n    <button type="button" class="trix-button trix-' +
                            'button--icon trix-button--icon-heading-1" data-trix-attribute="heading1" title' +
                            '="' + t.heading1 + '" tabindex="-1">' + t.heading1 + '</button>\n    <button t' +
                            'ype="button" class="trix-button trix-button--icon trix-button--icon-quote" dat' +
                            'a-trix-attribute="quote" title="' + t.quote + '" tabindex="-1">' + t.quote + '</button>\n    <button type="button" class="trix-button trix-button--icon trix' +
                            '-button--icon-code" data-trix-attribute="code" title="' + t.code + '" tabindex' +
                            '="-1">' + t.code + '</button>\n    <button type="button" class="trix-button tr' +
                            'ix-button--icon trix-button--icon-bullet-list" data-trix-attribute="bullet" ti' +
                            'tle="' + t.bullets + '" tabindex="-1">' + t.bullets + '</button>\n    <button ' +
                            'type="button" class="trix-button trix-button--icon trix-button--icon-number-li' +
                            'st" data-trix-attribute="number" title="' + t.numbers + '" tabindex="-1">' + t.numbers +
                            '</button>\n    <button type="button" class="trix-button trix-button--icon trix' +
                            '-button--icon-decrease-nesting-level" data-trix-action="decreaseNestingLevel" ' +
                            'title="' + t.outdent + '" tabindex="-1">' + t.outdent + '</button>\n    <butto' +
                            'n type="button" class="trix-button trix-button--icon trix-button--icon-increas' +
                            'e-nesting-level" data-trix-action="increaseNestingLevel" title="' + t.indent +
                            '" tabindex="-1">' + t.indent + '</button>\n  </span>\n\n  <span class="trix-bu' +
                            'tton-group trix-button-group--file-tools" data-trix-button-group="file-tools">' +
                            '\n    <button type="button" class="trix-button trix-button--icon trix-button--' +
                            'icon-attach" data-trix-action="attachFiles" title="' + t.attachFiles + '" tabi' +
                            'ndex="-1">' + t.attachFiles + '</button>\n  </span>\n\n  <span class="trix-but' +
                            'ton-group-spacer"></span>\n\n  <span class="trix-button-group trix-button-grou' +
                            'p--history-tools" data-trix-button-group="history-tools">\n    <button type="b' +
                            'utton" class="trix-button trix-button--icon trix-button--icon-undo" data-trix-' +
                            'action="undo" data-trix-key="z" title="' + t.undo + '" tabindex="-1">' + t.undo +
                            '</button>\n    <button type="button" class="trix-button trix-button--icon trix' +
                            '-button--icon-redo" data-trix-action="redo" data-trix-key="shift+z" title="' +
                            t.redo + '" tabindex="-1">' + t.redo + '</button>\n  </span>\n</div>\n\n<div cl' +
                            'ass="trix-dialogs" data-trix-dialogs>\n  <div class="trix-dialog trix-dialog--' +
                            'link" data-trix-dialog="href" data-trix-dialog-attribute="href">\n    <div cla' +
                            'ss="trix-dialog__link-fields">\n      <input type="url" name="href" class="tri' +
                            'x-input trix-input--dialog" placeholder="' + t.urlPlaceholder +
                            '" aria-label="' + t.url + '" required data-trix-input>\n      <div class="trix' +
                            '-button-group">\n        <input type="button" class="trix-button trix-button--' +
                            'dialog" value="' + t.link + '" data-trix-method="setAttribute">\n        <inpu' +
                            't type="button" class="trix-button trix-button--dialog" value="' + t.unlink +
        ...
        function () {
            e.config.input = {
                ...
                fileInputId: "trix-file-input-" + Date
                    .now()
                    .toString(16)
            }
        }.call(this),
        ...
        function () {
            ...
            e.ObjectView = function (n) {
                ...
                o.prototype.findOrCreateCachedChildView = function (t, e) {
                    var n;
                    return (n = this.getCachedViewForObject(e))
                ...
                o.prototype.createChildView = function (t, n, i) {
                    var o;
                    return null == i && (i = {}),
                    n instanceof e.ObjectGroup && (i.viewClass = t, t = e.ObjectGroupView),
                    o = new t(n, i),
                    this.recordChildView(o)
                },
                o.prototype.recordChildView = function (t) {
                    return t.parentView = this,
            ...
            e.ObjectGroupView = function (e) {
                ...
                n.prototype.getChildViews = function () {
                    ...
                    if (!this.childViews.length) 
                        for (i = this.objectGroup.getObjects(), t = 0, e = i.length; e > t; t++) 
                            n = i[t],
                            this.findOrCreateCachedChildView(this.viewClass, n, this.options);
                ...
                n.prototype.createContainerElement = function (t) {
                    return null == t && (t = this.objectGroup.getDepth()),
                    this
                        .getChildViews()[0]
            ...
            e.MutationObserver = function (e) {
                ...
                c.prototype.didMutate = function (t) {
                    ...
                    return (e = this.mutations)
                        .push
                        .apply(e, this.findSignificantMutations(t)),
                    this.mutations.length
                        ? (
                            null != (n = this.delegate) && "function" == typeof n.elementDidMutate && n.elementDidMutate(this.getMutationSummary()),
                            this.reset()
                        )
                        : void 0
                },
                ...
                c.prototype.findSignificantMutations = function (t) {
                    ...
                    for (o = [], e = 0, n = t.length; n > e; e++) 
                        i = t[e],
                        this.mutationIsSignificant(i) && o.push(i);
                    return o
                },
                c.prototype.mutationIsSignificant = function (t) {
                    var e,
                        ...
                        i,
                        o;
                    if (this.nodeIsMutable(t.target)) 
                        return !1;
                    for (o = this.nodesModifiedByMutation(t), e = 0, n = o.length; n > e; e++) 
                        if (i = o[e], this.nodeIsSignificant(i)) 
                            return !0;
                return !1
                },
                ...
                c.prototype.nodesModifiedByMutation = function (t) {
                    ...
                    switch (e = [], t.type) {
                        case "attributes":
                            ...
                            break;
                        case "characterData":
                            e.push(t.target.parentNode),
                            e.push(t.target);
                            break;
                        case "childList":
                            e
                                .push
                                .apply(e, t.addedNodes),
                            e
                                .push
                                .apply(e, t.removedNodes)
                    }
                    return e
                },
                ...
                c.prototype.getTextChangesFromChildList = function () {
                    ...
                    for (
                        ...
                        t
                            .push
                            .apply(t, s.addedNodes),
                        u
                            .push
                            .apply(u, s.removedNodes);
                    return c = 0 === t.length && 1 === u.length && n(u[0]),
                    c
                        ? (p = [], d = ["\n"])
                        : (p = h(t), d = h(u)), {
                        additions: function () {
                ...
                c.prototype.getTextChangesFromCharacterData = function () {
                    var t,
                        ...
                        u,
                        c;
                    return e = this.getMutationsByType("characterData"),
                    e.length && (
                        c = e[0],
                        n = e[e.length - 1],
                        s = o(c.oldValue),
        ...
        function () {
            ...
            e.InputController = function (o) {
                function r(n) {
                    var i;
                    this.element = n,
                    this.mutationObserver = new e.MutationObserver(this.element),
                ...
                r.prototype.requestRender = function () {
                    var t;
                    return null != (t = this.delegate) && "function" == typeof t.inputControllerDidRequestRender
                        ? t.inputControllerDidRequestRender()
                        : void 0
                },
                r.prototype.requestReparse = function () {
                    var t;
                    return null != (t = this.delegate) && "function" == typeof t.inputControllerDidRequestReparse && t.inputControllerDidRequestReparse(),
                    this.requestRender()
                },
                r.prototype.attachFiles = function (t) {
                    ...
                    return i = function () {
                        ...
                        for (r = [], i = 0, o = t.length; o > i; i++) 
                            n = t[i],
                            r.push(new e.FileVerificationOperation(n));
                        return r
                    }(),
                    Promise
                        .all(i)
                        .then(function (t) {
                            return function (e) {
                                return t.handleInput(function () {
                                    var t,
                                        n;
                                    return null != (t = this.delegate) && t.inputControllerWillAttachFiles(),
                            ...
                            return i.defaultPrevented
                                ...
                                : e.handleInput(function () {
                                    return n(this.element)
                                        ? void 0
                                        : (this.eventName = t, this.events[t].call(this, i))
                                })
                        }
                    }(this)
                },
                r.prototype.handleInput = function (t) {
                    var e,
                        n;
                    try {
                        return null != (e = this.delegate) && e.inputControllerWillHandleInput(),
                        t.call(this)
                    } finally {
                ...
                r.prototype.createLinkHTML = function (t, e) {
                    var n;
                    return n = document.createElement("a"),
                    n.href = t,
                    n.textContent = null != e
                        ? e
                        : t,
                    n.outerHTML
                },
        ...
        function () {
            ...
            e.Level0InputController = function (n) {
                ...
                s.prototype.elementDidMutate = function (t) {
                    ...
                    return this.isComposing()
                        ...
                        : this.handleInput(function () {
                            return this.mutationIsSignificant(t) && (
                ...
                s.prototype.events = {
                    keydown: function (t) {
                        ...
                        return a(t) && (n = String.fromCharCode(t.keyCode).toLowerCase()) && (
                            s = function () {
                                var e,
                                    n,
                                    i,
                    ...
                    dragstart: function (t) {
                        ...
                        null != (e = this.delegate) && "function" == typeof e.inputControllerDidStartDrag
                    ...
                    dragover: function (t) {
                        var e,
                            n;
                        return !this.draggedRange && !this.canAcceptDataTransfer(t.dataTransfer) || (
                            t.preventDefault(),
                            e = {
                                x: t.clientX,
                                y: t.clientY
                            ...
                            : (
                                ...
                                null != (n = this.delegate) && "function" == typeof n.inputControllerDidReceiveDragOverPoint
                                    ? n.inputControllerDidReceiveDragOverPoint(this.draggingPoint)
                                    : void 0
                            )
                    },
                    dragend: function () {
                        var t;
                        return null != (t = this.delegate) && "function" == typeof t.inputControllerDidCancelDrag && t.inputControllerDidCancelDrag(),
                    ...
                    drop: function (t) {
                        ...
                        (
                            ...
                            : this.draggedRange
                                ? (
                                    null != (u = this.delegate) && u.inputControllerWillMoveText(),
                                    null != (c = this.responder) && c.moveTextFromRange(this.draggedRange),
                                    this.draggedRange = null,
                                    this.requestRender()
                                )
                                : (i = t.dataTransfer.getData("application/x-trix-document")) && (
                    ...
                    paste: function (t) {
                        var n,
                            ...
                            D,
                            L;
                        return n = null != (p = t.clipboardData)
                            ? p
                            : t.testClipboardData,
                        l = {
                            clipboard: n
                        ...
                        null == n || h(t)
                            ? void this.getPastedHTMLUsingHiddenElement(function (t) {
                                return function (e) {
                                    var n,
                                        i,
                                        o;
                            ...
                            : (
                                (a = n.getData("URL"))
                                    ? (
                                        ...
                                        this.setInputSummary({textAdded: L, didDelete: this.selectionIsExpanded()}),
                                        null != (C = this.responder) && C.insertHTML(l.html),
                                        this.requestRender(),
                                    ...
                                    : i(n)
                                        ...
                                        : (u = n.getData("text/html"))
                                            ...
                                            : m.call(n.types, "Files") >= 0 && (
                                                s = null != (g = n.items) && null != (v = g[0]) && "function" == typeof v.getAsFile
                                                    ? v.getAsFile()
                                                    : void 0
                                            ) && (
                ...
                s.prototype.keys = {
                    backspace: function (t) {
                        var e;
                        return null != (e = this.delegate) && e.inputControllerWillPerformTyping(),
                    ...
                    tab: function (t) {
                        ...
                        return (
                            ...
                            ? (
                                null != (n = this.responder) && n.increaseNestingLevel(),
                                this.requestRender(),
                                t.preventDefault()
                            )
                            : void 0
                    ...
                    shift: {
                        ...
                        tab: function (t) {
                            ...
                            return (
                                ...
                                ? (
                                    null != (n = this.responder) && n.decreaseNestingLevel(),
                                    this.requestRender(),
                                    t.preventDefault()
                                )
                                : void 0
                        ...
                        left: function (t) {
                            return this.selectionIsInCursorTarget()
                                ? (t.preventDefault(), this.expandSelectionInDirection("backward"))
                                : void 0
                        },
                        right: function (t) {
                            return this.selectionIsInCursorTarget()
                                ? (t.preventDefault(), this.expandSelectionInDirection("forward"))
                                : void 0
                        }
                    },
                    alt: {
                ...
                s.prototype.isComposing = function () {
                    return null != this.compositionInput && !this
                        .compositionInput
                        .isEnded()
                },
                ...
                s.prototype.serializeSelectionToDataTransfer = function (t) {
                    var n,
                        i;
                    if (o(t)) 
                        return n = null != (i = this.responder)
                            ? i
                                .getSelectedDocument()
                                .toSerializableDocument()
                            : void 0,
                ...
                s.prototype.getPastedHTMLUsingHiddenElement = function (t) {
                    var n,
                        i,
                        o;
                    return i = this.getSelectedRange(),
                    o = {
                        position: "absolute",
            ...
            h = function (t) {
                ...
                if (u = t.clipboardData) {
                    ...
                    return o = m.call(u.types, "com.apple.webarchive") >= 0,
                ...
                e.prototype.start = function (t) {
                    ...
                    this.isSignificant()
                        ? (
                            ...
                            this.range = null != (n = this.responder)
                                ? n.getSelectedRange()
                                : void 0
                        )
                        : void 0
        ...
        function () {
            ...
            e.Level2InputController = function (s) {
                function u() {
                    return this.render = o(this.render, this),
                    u
                        .__super__
                        .constructor
                        .apply(this, arguments)
                ...
                u.prototype.render = function () {
                    var t;
                    return cancelAnimationFrame(this.scheduledRender),
                ...
                u.prototype.events = {
                        ...
                        return h(t)
                            ...
                            : p(t)
                                ? (
                                    ...
                                    null != (i = this.delegate) && i.inputControllerWillPaste(n),
                                    null != (o = this.responder) && o.insertString(n.string),
                                    this.render(),
                                    null != (r = this.delegate)
                                ...
                                : (
                                    ...
                                    ? (
                                        ...
                                        null != (a = this.delegate) && a.inputControllerWillPaste(n),
                    ...
                    dragstart: function (t) {
                        ...
                        return (
                            ...
                            ? (t.dataTransfer.setData("application/x-trix-dragging", !0), this.dragging = {
                                range: null != (n = this.responder)
                                    ? n.getSelectedRange()
                                    : void 0,
                                point: d(t)
                            })
                    ...
                    dragover: function (t) {
                        var e,
                            n;
                        if (this.dragging) {
                            if (t.preventDefault(), e = d(t), !i(e, this.dragging.point)) 
                                return this.dragging.point = e,
                                null != (n = this.responder)
                        ...
                        return this.dragging
                            ...
                            : c(t)
                                ? (
                                    t.preventDefault(),
                                    e = d(t),
                                    null != (o = this.responder) && o.setLocationRangeFromPointRange(e),
                    ...
                    dragend: function () {
                        ...
                        return this.dragging
                            ? (
                                null != (t = this.responder) && t.setSelectedRange(this.dragging.range),
                                this.dragging = null
                            )
                            : void 0
                    },
                ...
                u.prototype.keys = {
                    ...
                    Backspace: function () {
                        ...
                        return (
                            ...
                            ? (
                                this.event.preventDefault(),
                                null != (e = this.delegate) && e.inputControllerWillPerformTyping(),
                                null != (n = this.responder) && n.deleteInDirection("backward"),
                                this.render()
                            )
                            : void 0
                    },
                    Tab: function () {
                        ...
                        return (
                            ...
                            ? (
                                this.event.preventDefault(),
                                null != (e = this.responder) && e.increaseNestingLevel(),
                                this.render()
                            )
                            : void 0
                    },
                    "Tab+Shift": function () {
                        ...
                        return (
                            ...
                            ? (
                                this.event.preventDefault(),
                                null != (e = this.responder) && e.decreaseNestingLevel(),
                                this.render()
                            )
                            : void 0
                    }
                ...
                u.prototype.inputTypes = {
                    ...
                    deleteByDrag: function () {
                        ...
                        this.withTargetDOMRange(function () {
                            var t;
                            return this.deleteByDragRange = null != (t = this.responder)
                                ? t.getSelectedRange()
                                : void 0
                        })
                    },
                    ...
                    insertFromPaste: function () {
                        var n,
                            ...
                            h,
                            p;
                        return n = this.event.dataTransfer,
                        s = {
                            dataTransfer: n
                        },
                        (i = n.getData("URL"))
                    ...
                    insertParagraph: function () {
                        var t;
                        return null != (t = this.delegate) && t.inputControllerWillPerformTyping(),
                        this.withTargetDOMRange(function () {
                            var t;
                            return null != (t = this.responder)
                                ? t.insertLineBreak()
                ...
                u.prototype.withTargetDOMRange = function (t, n) {
                    var i;
                    return "function" == typeof t && (n = t, t = this.getTargetDOMRange()),
                    t
                ...
                u.prototype.getTargetDOMRange = function (t) {
                    ...
                    (
                        o = "function" == typeof(e = this.event).getTargetRanges
                            ? e.getTargetRanges()
                            : void 0
                    ) && o.length && (n = f(o[0]), 0 === i || n.toString().length >= i)
                        ? n
                        : void 0
                },
                f = function (t) {
                ...
                h = function (t) {
                    ...
                    return (e = t.clipboardData)
                        ? a.call(e.types, "Files") >= 0 && 1 === e.types.length && e.files.length >= 1
                        : void 0
                },
                p = function (t) {
                    var e;
        ...
        function () {
            ...
            e.AttachmentEditorController = function (a) {
                function h(t, e, n, i) {
                    ...
                    this.didClickActionButton = c(this.didClickActionButton, this),
                    this.didClickToolbar = c(this.didClickToolbar, this),
                    this.attachment = this.attachmentPiece.attachment,
                    "a" === u(this.element) && (this.element = this.element.firstChild),
                    this.install()
                }
                var p;
                return l(h, a),
                ...
                h.prototype.install = function () {
                    return this.makeElementMutable(),
                    this.addToolbar(),
                    this
                        .attachment
                        .isPreviewable()
                    ...
                    this
                        ...
                        childNodes: s({
                            ...
                            childNodes: [
                                ...
                                s({
                                    tagName: "span", className: t.attachmentSize, textContent: this
                                        .attachment
                    ...
                    a = u.cloneNode(), {
                        "do": function (e) {
                            return function () {
                                ...
                                a
                                    .classList
                                    .add(t.attachmentCaption + "--editing"),
                                u
                                    .parentElement
                                    .insertBefore(a, u),
                                o(),
                    ...
                    switch (e = t.target.getAttribute("data-trix-action")) {
                        case "remove":
                            return null != (n = this.delegate)
                                ? n.attachmentEditorDidRequestRemovalOfAttachment(this.attachment)
                                : void 0
                    }
                },
                h.prototype.didKeyDownCaption = function (t) {
                    ...
                    return "return" === o[t.keyCode]
                        ? (
                            ...
                            null != (e = this.delegate) && "function" == typeof e.attachmentEditorDidRequestDeselectingAttachment
                                ? e.attachmentEditorDidRequestDeselectingAttachment(this.attachment)
                                : void 0
                        )
                        : void 0
                },
                h.prototype.didInputCaption = function (t) {
                    return this.pendingCaption = t
                        .target
                        .value
                        .replace(/\s/g, " ")
                        .trim()
        ...
        function () {
            ...
            e.AttachmentView = function (r) {
                ...
                s.prototype.createNodes = function () {
                    ...
                    }), e.appendChild(r)), this.attachment.hasContent()) 
                        r.innerHTML = this
                            .attachment
                            .getContent();
                    else 
                        for (c = this.createContentNodes(), o = 0, s = c.length; s > o; o++) 
                            u = c[o],
                            r.appendChild(u);
                return r.appendChild(this.createCaptionElement()),
                    this
                        .attachment
                        .isPending() && (this.progressElement = i({
                            tagName: "progress",
                            attributes: {
                ...
                s.prototype.createCaptionElement = function () {
                    var e,
                        ...
                        a,
                        u;
                    return o = i({tagName: "figcaption", className: t.attachmentCaption}),
                    (e = this.attachmentPiece.getCaption())
                        ...
                        : (
                            ...
                            r && (
                                s = i({tagName: "span", className: t.attachmentName, textContent: r}),
                                o.appendChild(s)
                            ),
                            a && (
                                r && o.appendChild(document.createTextNode(" ")),
                                u = i({tagName: "span", className: t.attachmentSize, textContent: a}),
                                o.appendChild(u)
                            )
                        ),
                    o
                ...
                s.prototype.getClassName = function () {
                    var e,
                        n;
                    return n = [
                        t.attachment, t.attachment + "--" + this
                            .attachment
                            .getType()
                    ],
                    (e = this.attachment.getExtension()) && n.push(t.attachment + "--" + e),
                    n.join(" ")
                },
        ...
        function () {
            ...
            e.PreviewableAttachmentView = function (i) {
                ...
                o.prototype.refresh = function (t) {
                    var e;
                    return null == t && (
                        t = null != (e = this.findElement())
                            ? e.querySelector("img")
                            : void 0
                    ),
                    t
                        ? this.updateAttributesForImage(t)
                        : void 0
                },
                ...
                o.prototype.attachmentDidChangeAttributes = function () {
                    return this.refresh(this.image),
                    this.refresh()
                },
                o
            }(e.AttachmentView)
        ...
        function () {
            ...
            e.PieceView = function (r) {
                ...
                s.prototype.createAttachmentNodes = function () {
                    ...
                    return t = this
                        ...
                        .isPreviewable()
                            ...
                            : e.AttachmentView,
                    n = this.createChildView(t, this.piece.attachment, {piece: this.piece}),
                    n.getNodes()
                },
                ...
                s.prototype.createElement = function () {
                    ...
                    a = this.attributes;
                    for (r in a) 
                        if (l = a[r], (t = n(r)) && (t.tagName && (
                            s = i(t.tagName),
                            o
                                ? (o.appendChild(s), o = s)
                                : e = o = s
                        ), t.styleProperty && (c[t.styleProperty] = l), t.style)) {
                            u = t.style;
                            for (r in u) 
                                l = u[r],
                                c[r] = l
                ...
                s.prototype.preserveSpaces = function (t) {
                    return this.context.isLast && (t = t.replace(/\ $/, a)),
                    t = t
            ...
            e.TextView = function (n) {
                ...
                i.prototype.getPieces = function () {
                    ...
                    for (i = this.text.getPieces(), o = [], t = 0, e = i.length; e > t; t++) 
                        n = i[t],
                        n.hasAttribute("blockBreak") || o.push(n);
                    return o
                },
                o = function (t) {
                    return /\s$/.test(
            ...
            e.BlockView = function (r) {
                ...
                s.prototype.createNodes = function () {
                    ...
                    if (
                        ...
                        this.block.isEmpty()
                            ? c.push(i("br"))
                            : (
                                p = null != (l = n(this.block.getLastAttribute()))
                                    ? l.text
                                    : void 0,
                ...
                s.prototype.createContainerElement = function (e) {
                    ...
                    "attachmentGallery" === o && (
                        ...
                        s = t.attachmentGallery + " " + t.attachmentGallery + "--" + a
                    ),
            ...
            e.DocumentView = function (o) {
                ...
                r.prototype.sync = function () {
                    ...
                    for (t = this.createDocumentFragmentForSync(); this.element.lastChild;) 
                        this
                            .element
                            .removeChild(this.element.lastChild);
                    return this
                        .element
                        .appendChild(t),
                    this.didSync()
                ...
                r.prototype.createDocumentFragmentForSync = function () {
                    ...
                    for (c = a(e), i = 0, r = c.length; r > i; i++) 
                        t = c[i],
                        (l = this.elementStore.remove(t)) && t
                            .parentNode
                            .replaceChild(l, t);
                    return e
                },
            ...
            e.CompositionController = function (u) {
                    ...
                    return t = function (t) {
                        return function () {
                            ...
                            return t.focused
                                ...
                                : (
                                    t.focused = !0,
                                    null != (e = t.delegate) && "function" == typeof e.compositionControllerDidFocus
                    ...
                    return this.blurPromise = new Promise(function (t) {
                        return function (e) {
                            return n(function () {
                                ...
                                return r(t.element) || (
                                    t.focused = null,
                                    null != (n = t.delegate) && "function" == typeof n.compositionControllerDidBlur && n.compositionControllerDidBlur()
                                ),
                                t.blurPromise = null,
                                e()
                            })
                ...
                c.prototype.didClickAttachment = function (t, e) {
                    var n,
                        o,
                        r;
                    return n = this.findAttachmentForElement(e),
                    o = null != i(t.target, {matchingSelector: "figcaption"}),
                    null != (r = this.delegate) && "function" == typeof r.compositionControllerDidSelectAttachment
                        ? r.compositionControllerDidSelectAttachment(n, {editCaption: o})
                        : void 0
                },
                ...
                c.prototype.render = function () {
                    var t,
                        e,
                        n;
                    return this.revision !== this.composition.revision && (
                        this.documentView.setDocument(this.composition.document),
                        this.documentView.render(),
                        this.revision = this.composition.revision
                    ),
                    this.canSyncDocumentView() && !this
                        .documentView
                        .isSynced() && (
                    ...
                    null != (n = this.delegate) && "function" == typeof n.compositionControllerDidRender
                        ? n.compositionControllerDidRender()
                        : void 0
                },
                c.prototype.rerenderViewForObject = function (t) {
                    return this.invalidateViewForObject(t),
                    this.render()
                },
                ...
                c.prototype.installAttachmentEditorForAttachment = function (t, n) {
                    ...
                    if ((
                        null != (r = this.attachmentEditor)
                            ? r.attachment
                            : void 0
                    ) !== t && (o = this.documentView.findElementForObject(t))) 
                        return this.uninstallAttachmentEditor(),
                        i = this
                            .composition
                            .document
                ...
                c.prototype.attachmentEditorDidRequestUpdatingAttributesForAttachment = function (
                    ...
                    var n;
                    return null != (n = this.delegate) && "function" == typeof n.compositionControllerWillUpdateAttachment && n.compositionControllerWillUpdateAttachment(
                        e
                    ),
                    this
                        .composition
                ...
                c.prototype.attachmentEditorDidRequestRemovalOfAttachment = function (t) {
                    var e;
                    return null != (e = this.delegate) && "function" == typeof e.compositionControllerDidRequestRemovalOfAttachment
                        ? e.compositionControllerDidRequestRemovalOfAttachment(t)
                        : void 0
                },
                c.prototype.attachmentEditorDidRequestDeselectingAttachment = function (t) {
                    var e;
                    return null != (e = this.delegate) && "function" == typeof e.compositionControllerDidRequestDeselectingAttachment
                ...
                c.prototype.findAttachmentForElement = function (t) {
                    return this
                        .composition
                        .document
                        .getAttachmentById(parseInt(t.dataset.trixId, 10))
                },
                c
            }(e.BasicObject)
        }.call(this),
            ...
            e.ToolbarController = function (e) {
                ...
                s.prototype.didClickActionButton = function (t, e) {
                    var n,
                        i,
                        o;
                    return null != (i = this.delegate) && i.toolbarDidClickButton(),
                    t.preventDefault(),
                    n = d(e),
                    this.getDialog(n)
                        ? this.toggleDialog(n)
                ...
                s.prototype.didClickDialogButton = function (e, n) {
                    var i,
                        o;
                    return i = t(n, {matchingSelector: p}),
                ...
                s.prototype.refreshAttributeButtons = function () {
                    return this.eachAttributeButton(function (t) {
                        return function (e, n) {
                            return e.disabled = t.attributes[n] === !1,
                ...
                s.prototype.applyKeyboardCommand = function (t) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            return i("mousedown", {onElement: e}),
                            !0;
                return !1
                },
                ...
                s.prototype.showDialog = function (t) {
                    ...
                    return (e = f(i)) && (r = m(i, t)) && (
                        r.value = null != (c = this.attributes[e])
                            ? c
                            : "",
                        r.select()
                    ),
                ...
                s.prototype.setAttribute = function (t) {
                    ...
                    n.willValidate && !n.checkValidity()
                        ...
                        : (
                            null != (i = this.delegate) && i.toolbarDidUpdateAttribute(e, n.value),
                            this.hideDialog()
                        )
                },
                ...
                s.prototype.getDialog = function (t) {
                    return this
                        .element
                        .querySelector("[data-trix-dialog=" + t + "]")
                },
                m = function (t, e) {
                    return null == e && (e = f(t)),
        ...
        function () {
            ...
            e.ImagePreloadOperation = function (e) {
                ...
                n.prototype.perform = function (t) {
                    ...
                    e.onload = function (n) {
                        return function () {
                            return e.width = n.width = e.naturalWidth,
        ...
        function () {
            ...
            e.Attachment = function (i) {
                ...
                o.attachmentForFile = function (t) {
                    var e,
                        n;
                    return n = this.attributesForFile(t),
                    e = new this(n),
                    e.setFile(t),
                    e
                },
                    ...
                    this
                        ...
                        .isEqualTo(e)
                            ...
                            : (
                                ...
                                null != (i = this.delegate) && "function" == typeof i.attachmentDidChangeAttributes
                ...
                o.prototype.releaseFile = function () {
                    return this.releasePreloadedFile(),
                    this.file = null
                },
                o.prototype.getUploadProgress = function () {
                    var t;
                    return null != (t = this.uploadProgress)
                        ? t
                        : 0
                },
                ...
                o.prototype.setPreviewURL = function (t) {
                    ...
                    return t !== this.getPreviewURL()
                        ? (
                            ...
                            null != (n = this.delegate) && "function" == typeof n.attachmentDidChangePreviewURL
                        ...
                        ? (
                            ...
                            i.then(function (e) {
                                return function (i) {
                                    ...
                                    return r = i.width,
                                    o = i.height,
                                    e.getWidth() && e.getHeight() || e.setAttributes({width: r, height: o}),
        ...
        function () {
            ...
            e.Piece = function (n) {
                    ...
                    return (n = pieceList.getPieceAtIndex(0))
                        ? (
                            ...
                            pieceList.eachPiece(function (n) {
                                return e = t.getKeysCommonToHash(n.attributes),
                                t = t.slice(e)
                            }),
                            t.toObject()
                        )
                ...
                i.prototype.hasSameAttributesAsPiece = function (t) {
                    return null != t && (
                        this.attributes === t.attributes || this.attributes.isEqualTo(t.attributes)
                    )
                },
                ...
                i.prototype.isEqualTo = function (t) {
                    return i
                        .__super__
                        .isEqualTo
                        .apply(this, arguments) || this.hasSameConstructorAs(t) && this.hasSameStringValueAsPiece(
                            t
                ...
                i.prototype.contentsForInspection = function () {
                    return {
                        type: this.constructor.type, attributes: this
                            .attributes
                            .inspect()
                    }
                },
        ...
        function () {
            ...
            e
                .Piece
                .registerType("attachment", e.AttachmentPiece = function (n) {
                    function i(t) {
                        this.attachment = t,
                        i
                            .__super__
                        ...
                        this
                            .attachment
                            .hasContent() || this.removeProhibitedAttributes()
                    }
                    return t(i, n),
                    i.fromJSON = function (t) {
                    ...
                    i.prototype.removeProhibitedAttributes = function () {
                        ...
                        return t = this
                            .attributes
                            .slice(this.constructor.permittedAttributes),
                    ...
                    i.prototype.isEqualTo = function (t) {
                        ...
                        return i
                            .__super__
                            .isEqualTo
                            .apply(this, arguments) && this.attachment.id === (
        ...
        function () {
            ...
            e
                .Piece
                .registerType("string", e.StringPiece = function (e) {
                    function i(e) {
                        i
                            .__super__
                            .constructor
                    ...
                    i.prototype.canBeConsolidatedWith = function (t) {
                        return null != t && this.hasSameConstructorAs(t) && this.hasSameAttributesAsPiece(
                            t
                        )
                    },
            ...
            e.SplittableList = function (e) {
                ...
                i.prototype.splice = function () {
                    ...
                    return e = 1 <= arguments.length
                        ? o.call(arguments, 0)
                        : [],
                    new this.constructor(t.apply(null, [this.objects].concat(o.call(e))))
                },
                ...
                i.prototype.insertSplittableListAtIndex = function (t, e) {
                    return this
                        .splice
                        .apply(this, [e, 0].concat(o.call(t.objects)))
                },
                i.prototype.insertSplittableListAtPosition = function (t, e) {
                    var n,
                        i,
                        o;
                    return o = this.splitObjectAtPosition(e),
                    i = o[0],
                    n = o[1],
                    new this
                        .constructor(i)
                        .insertSplittableListAtIndex(t, n)
                },
                ...
                i.prototype.getSplittableListInRange = function (t) {
                    var e,
                        ...
                        i,
                        o;
                    return i = this.splitObjectsAtRange(t),
                    n = i[0],
                    e = i[1],
                    o = i[2],
                ...
                i.prototype.transformObjectsInRange = function (t, e) {
                    var n,
                        ...
                        a,
                        u;
                    return s = this.splitObjectsAtRange(t),
                    r = s[0],
                    i = s[1],
                    a = s[2],
                    u = function () {
                ...
                i.prototype.splitObjectsAtRange = function (t) {
                    var e,
                        ...
                        s,
                        u;
                    return o = this.splitObjectAtPosition(a(t)),
                    n = o[0],
                    e = o[1],
                    i = o[2],
                    s = new this
                        .constructor(n)
                        .splitObjectAtPosition(r(t) + i),
                    n = s[0],
                    u = s[1],
                    [
                        n, e, u - 1
                ...
                i.prototype.getObjectAtPosition = function (t) {
                    var e,
                        n,
                        i;
                    return i = this.findIndexAndOffsetAtPosition(t),
                    e = i.index,
                    n = i.offset,
                    this.objects[e]
                },
                i.prototype.splitObjectAtPosition = function (t) {
                    var e,
                        ...
                        c,
                        l;
                    return s = this.findIndexAndOffsetAtPosition(t),
                    e = s.index,
                    r = s.offset,
                    o = this
                        .objects
                ...
                i.prototype.consolidateFromIndexToIndex = function (t, e) {
                    ...
                    this
                        .splice
                        .apply(this, [t, r.length].concat(o.call(n)))
                },
            ...
            e.Text = function (n) {
                function i(t) {
                    ...
                    i
                        ...
                        .constructor
                        .apply(this, arguments),
                    this.pieceList = new e.SplittableList(function () {
                        var e,
                            i,
                            o;
                ...
                i.textForAttachmentWithAttributes = function (t, n) {
                    var i;
                    return i = new e.AttachmentPiece(t, n),
                    new this([i])
                },
                i.textForStringWithAttributes = function (t, n) {
                    var i;
                    return i = new e.StringPiece(t, n),
                    new this([i])
                },
                i.fromJSON = function (t) {
                    var n,
                ...
                i.prototype.replaceTextAtRange = function (t, e) {
                    return this
                        .removeTextAtRange(e)
                        .insertTextAtPosition(t, e[0])
                },
                i.prototype.moveTextFromRangeToPosition = function (t, e) {
                    var n,
                        i;
                    if (!(t[0] <= e && e <= t[1])) 
                        return i = this.getTextAtRange(t),
                        n = i.getLength(),
                        t[0] < e && (e -= n),
                        this
                            .removeTextAtRange(t)
                            .insertTextAtPosition(i, e)
                    },
                i.prototype.addAttributeAtRange = function (t, e, n) {
                    var i;
                    return i = {},
                    i[t] = e,
                    this.addAttributesAtRange(i, n)
                },
                ...
                i.prototype.getAttributesAtPosition = function (t) {
                    var e,
                        n;
                    return null != (
                        e = null != (n = this.pieceList.getObjectAtPosition(t))
                            ? n.getAttributes()
                            : void 0
                    )
                        ? e
                ...
                i.prototype.getCommonAttributes = function () {
                    ...
                    return t = function () {
                        ...
                        for (i = this.pieceList.toArray(), o = [], t = 0, e = i.length; e > t; t++) 
                            n = i[t],
                            o.push(n.getAttributes());
                        return o
                    }.call(this),
                    e
                        .Hash
                        .fromCommonAttributesOfObjects(t)
                        .toObject()
                },
                ...
                i.prototype.getExpandedRangeForAttributeAtOffset = function (t, e) {
                    ...
                    for (
                        n = o = e,
                        i = this.getLength();
                        n > 0 && this.getCommonAttributesAtRange([
                            n - 1,
                            o
                        ])[t];
                    ) 
                ...
                i.prototype.getAttachmentById = function (t) {
                    var e,
                        n,
                        i;
                    return i = this.getAttachmentAndPositionById(t),
                    e = i.attachment,
                    n = i.position,
                    e
                },
                i.prototype.getRangeOfAttachment = function (t) {
                    var e,
                        n;
                    return n = this.getAttachmentAndPositionById(t.id),
                    t = n.attachment,
                    e = n.position,
                    null != t
                        ? [
                ...
                i.prototype.toSerializableText = function () {
                    ...
                    return t = this
                        .pieceList
                        .selectSplittableList(function (t) {
            ...
            e.Block = function (n) {
                ...
                a.prototype.increaseNestingLevel = function () {
                    var t,
                        ...
                        n;
                    return (t = this.getLastNestableAttribute())
                        ? (n = this.attributes.lastIndexOf(t), e = r.apply(null, [
                            this.attributes, n + 1,
                            0
                        ].concat(c.call(d(t)))), this.copyWithAttributes(e))
                        : this
                },
                ...
                a.prototype.getTextWithoutBlockBreak = function () {
                    return m(this.text)
                        ? this
                            .text
                            .getTextAtRange([0, this.getBlockBreakPosition()])
                        : this
                            .text
                            .copy()
                },
                ...
                a.prototype.canBeGroupedWith = function (t, e) {
                    var n,
                        ...
                        s,
                        a;
                    return s = t.getAttributes(),
                    r = s[e],
                    n = this.attributes[e],
                    !(
                        n !== r || i(n).group === !1 && (a = s[e + 1], u.call(o(), a) < 0) || this.getDirection() !== t.getDirection() && !t.isEmpty()
                    )
                },
                h = function (t) {
                    return t = y(t),
        ...
        function () {
            ...
            e.HTMLSanitizer = function (r) {
                function u(t, e) {
                    ...
                    null == this.allowedAttributes && (this.allowedAttributes = c),
                    null == this.forbiddenProtocols && (this.forbiddenProtocols = h),
                    null == this.forbiddenElements && (this.forbiddenElements = l),
                    this.body = p(t)
                }
                var c,
                    l,
                ...
                u.prototype.sanitizeElement = function (t) {
                    var e,
                        ...
                        o,
                        r;
                    for (t.hasAttribute("href") && (
                        o = t.protocol,
                        s.call(this.forbiddenProtocols, o) >= 0 && t.removeAttribute("href")
                    ), r = a.call(t.attributes), e = 0, n = r.length; n > e; e++) 
                        i = r[e].name,
                        s.call(this.allowedAttributes, i) >= 0 || 0 === i.indexOf("data-trix") || t.removeAttribute(
                            i
                        );
                    return t
                },
                u.prototype.normalizeListElementNesting = function () {
                    ...
                    for (
                        ...
                        i = r[t],
                        (o = i.previousElementSibling) && "li" === n(o) && o.appendChild(i);
                    return this.body
                },
                ...
                u.prototype.elementIsForbidden = function (t) {
                    var e;
                    return e = n(t),
                    s.call(this.forbiddenElements, e) >= 0
                },
        ...
        function () {
            ...
            e.HTMLParser = function (d) {
                    ...
                    switch (t.nodeType) {
                        case Node.TEXT_NODE:
                            if (!this.isInsignificantTextNode(t)) 
                                return this.appendBlockForTextNode(t),
                                this.processTextNode(t);
                            break;
                        case Node.ELEMENT_NODE:
                            return this.appendBlockForElement(t),
                ...
                g.prototype.appendBlockForTextNode = function (e) {
                    ...
                    i === this.currentBlockElement && this.isBlockElement(e.previousSibling)
                        ? this.appendStringWithAttributes("\n")
                        : i !== this.containerElement && !this.isBlockElement(i) || (
                            ...
                            ? void 0
                            : (
                                this.currentBlock = this.appendBlockForAttributesWithElement(n, i),
                ...
                g.prototype.appendBlockForElement = function (e) {
                    ...
                    if (
                        ...
                        if ((!this.isInsignificantTextNode(e.firstChild) || !this.isBlockElement(e.firstElementChild)) && (n = this.getBlockAttributes(e), e.firstChild)) 
                            return o && t(n, this.currentBlock.attributes)
                                ? this.appendStringWithAttributes("\n")
                                : (
                                    this.currentBlock = this.appendBlockForAttributesWithElement(n, e),
                ...
                g.prototype.findParentBlockElement = function (t) {
                    ...
                    for (e = t.parentElement; e && e !== this.containerElement;) {
                        if (this.isBlockElement(e) && f.call(this.blockElements, e) >= 0) 
                            return e;
                        e = e.parentElement
                    }
                    return null
                ...
                g.prototype.processTextNode = function (t) {
                    var e,
                        n;
                    return n = t.data,
                    v(t.parentNode) || (n = c(n), R(
                        null != (e = t.previousSibling)
                            ? e.textContent
                            : void 0
                    ) && (n = A(n))),
                    this.appendStringWithAttributes(n, this.getTextAttributes(t.parentNode))
                },
                    ...
                    switch (l(t)) {
                        ...
                        case "img":
                            ...
                            for (n in i) 
                                r = i[n],
                                e[n] = r;
                            return this.appendAttachmentWithAttributes(e, this.getTextAttributes(t)),
                            this
                                .processedElements
                                .push(t);
                        case "tr":
                ...
                g.prototype.appendPiece = function (t) {
                    return 0 === this.blocks.length && this.appendEmptyBlock(),
                    this
                ...
                g.prototype.getTextAttributes = function (t) {
                    ...
                    for (n in p) 
                        ...
                        u.styleProperty && (g = t.style[u.styleProperty]) && (r[n] = g);
                    if (a(t)) {
                        f = w(t, "attributes");
                        for (l in f) 
                            g = f[l],
                ...
                g.prototype.getBlockAttributes = function (t) {
                    ...
                    for (i = []; t && t !== this.containerElement;) {
                        ...
                        for (n in r) 
                            o = r[n],
                            o.parse !== !1 && l(t) === o.tagName && ((
                                "function" == typeof o.test
                                    ? o.test(t)
                                    : void 0
                            ) || !o.test) && (i.push(n), o.listAttribute && i.push(o.listAttribute));
                        t = t.parentNode
                    }
                    return i.reverse()
                },
                ...
                g.prototype.isBlockElement = function (t) {
                    ...
                    if ((
                        null != t
                            ? t.nodeType
                            : void 0
                    ) === Node.ELEMENT_NODE && !a(t) && !o(t, {
                        matchingSelector: "td",
                        untilNode: this.containerElement
                    })) 
                        return e = l(t),
                        f.call(r(), e) >= 0 || "block" === window
                            .getComputedStyle(t)
                            .display
                    },
                g.prototype.isInsignificantTextNode = function (t) {
                    ...
                    if ((
                        null != t
                            ? t.nodeType
                            : void 0
                    ) === Node.TEXT_NODE && k(t.data) && (
                        n = t.parentNode,
                        i = t.previousSibling,
                        e = t.nextSibling,
                        (!C(n.previousSibling) || this.isBlockElement(n.previousSibling)) && !v(n)
                    )) 
                ...
                g.prototype.translateBlockElementMarginsToNewlines = function () {
                    ...
                    for (
                        ...
                        (r = this.getMarginOfBlockElementAtIndex(i)) && (
                            r.top > 2 * e.top && this.prependStringToTextAtIndex("\n", i),
                            a.push(
                                r.bottom > 2 * e.bottom
                ...
                g.prototype.getMarginOfBlockElementAtIndex = function (t) {
                    var e,
                        n;
                    return !(e = this.blockElements[t]) || !e.textContent || (
                        n = l(e),
                        f.call(r(), n) >= 0 || f.call(this.processedElements, e) >= 0
                    )
                        ? void 0
                        : y(e)
                },
                g.prototype.getMarginOfDefaultBlockElement = function () {
                    var t;
                    return t = s(e.config.blockAttributes["default"].tagName),
                    this
                        .containerElement
                        .appendChild(t),
                    y(t)
        ...
        function () {
            ...
            e.Document = function (s) {
                ...
                c.fromString = function (t, n) {
                    ...
                    return i = e
                        .Text
                        .textForStringWithAttributes(t, n),
                    new this([new e.Block(i)])
                },
                c.prototype.isEmpty = function () {
                    var t;
                    return 1 === this.blockList.length && (
                ...
                c.prototype.copyUsingObjectsFromDocument = function (t) {
                    var n;
                    return n = new e.ObjectMap(t.getObjects()),
                ...
                c.prototype.mergeDocumentAtRange = function (e, n) {
                    ...
                    g = r.slice(-o.length),
                    t(o, g)
                        ? (l = r.slice(0, -o.length), c = e.copyWithBaseBlockAttributes(l))
                        : c = e
                            .copy({
                                consolidateBlocks: !0
                            })
                ...
                c.prototype.updateAttributesForAttachment = function (t, e) {
                    var n,
                        ...
                        o,
                        r;
                    return o = (i = this.getRangeOfAttachment(e))[0],
                    n = this
                        .locationFromPosition(o)
                        .index,
                    r = this.getTextAtIndex(n),
                    new this.constructor(this.blockList.editObjectAtIndex(n, function (n) {
                ...
                c.prototype.insertBlockBreakAtRange = function (t) {
                    ...
                    return s = (t = i(t))[0],
                    r = this
                        .locationFromPosition(s)
                        .offset,
                    o = this.removeTextAtRange(t),
                    0 === r && (n = [new e.Block]),
                    new this.constructor(
                        o.blockList.insertSplittableListAtPosition(new e.SplittableList(n), s)
                    )
                },
                c.prototype.applyBlockAttributeAtRange = function (t, e, i) {
                    var o,
                        ...
                        s,
                        a;
                    return s = this.expandRangeToLineBreaksAndSplitBlocks(i),
                    r = s.document,
                    i = s.range,
                    o = n(t),
                    o.listAttribute
                ...
                c.prototype.expandRangeToLineBreaksAndSplitBlocks = function (t) {
                    ...
                    null != (
                        c.offset = u.findLineBreakInDirectionFromPosition("backward", c.offset)
                    ) && (
                        s = e.positionFromLocation(c),
                        e = e.insertBlockBreakAtRange([
                            s, s + 1
                        ]),
                        o.index += 1,
                    ...
                    0 === o.offset && o.index > c.index
                        ...
                        : (
                            ...
                            "\n" === n.text.getStringAtRange([
                                ...
                                ? o.offset -= 1
                                : o.offset = n.findLineBreakInDirectionFromPosition("forward", o.offset),
                ...
                c.prototype.consolidateBlocksAtRange = function (t) {
                    ...
                    r = this
                        ...
                        .index,
                    e = this
                        .locationFromPosition(n)
                        .index,
                    new this.constructor(this.blockList.consolidateFromIndexToIndex(r, e))
                },
                ...
                c.prototype.eachBlockAtRange = function (t, e) {
                    ...
                    if (
                        ...
                        return n = this.getBlockAtIndex(p.index),
                        f = [
                            p.offset, o.offset
                        ],
                        e(n, f, p.index);
                    ...
                    o(t)
                        ...
                        : (
                            ...
                            this.eachBlockAtRange(t, function (t, e) {
                                return e[0] !== e[1]
                                    ? (s.push(t.text.getCommonAttributesAtRange(e)), n.push(l(t)))
                                    : void 0
                            }),
                ...
                c.prototype.getCommonAttributesAtPosition = function (t) {
                    ...
                    n = o
                        .text
                        .getAttributesAtPosition(h),
                    i = o
                        .text
                        .getAttributesAtPosition(h - 1),
                    a = function () {
                        var t,
                            n;
                        t = e.config.textAttributes,
                        n = [];
                        for (c in t) 
                            d = t[c],
                            d.inheritable && n.push(c);
                        return n
                    }();
                    for (c in i) 
                        d = i[c],
                        (d === n[c] || u.call(a, c) >= 0) && (r[c] = d);
                    return r
                },
                c.prototype.getRangeOfCommonAttributeAtPosition = function (t, e) {
                    var n,
                        ...
                        l,
                        h;
                    return a = this.locationFromPosition(e),
                    r = a.index,
                    s = a.offset,
                ...
                c.prototype.getLocationRangeOfAttachment = function (t) {
                    var e;
                    return e = this.getRangeOfAttachment(t),
                ...
                c.prototype.locationFromPosition = function (t) {
                    ...
                    return n = this
                        .blockList
                        .findIndexAndOffsetAtPosition(Math.max(0, t)),
                    null != n.index
                        ? n
                        : (e = this.getBlocks(), {
                            index: e.length - 1,
                ...
                c.prototype.positionFromLocation = function (t) {
                    return this
                        .blockList
                        .findPositionAtIndexAndOffset(t.index, t.offset)
                },
                ...
                c.prototype.toConsole = function () {
                    ...
                    return JSON.stringify(function () {
                        ...
                        for (i = this.blockList.toArray(), o = [], e = 0, n = i.length; n > e; e++) 
                            t = i[e],
                            o.push(JSON.parse(t.text.toConsole()));
                        return o
                    }.call(this))
                },
                c
        ...
        function () {
            e.LineBreakInsertion = function () {
                function t(t) {
                    ...
                    this.startLocation = this
                        .document
                        .locationFromPosition(this.startPosition),
                    this.endLocation = this
                        .document
                        .locationFromPosition(this.endPosition),
                    this.block = this
                        .document
                        .getBlockAtIndex(this.endLocation.index),
                    this.breaksOnReturn = this
                        .block
                        .breaksOnReturn(),
                    this.previousCharacter = this
                        .block
                        .text
                        .getStringAtPosition(this.endLocation.offset - 1),
                    this.nextCharacter = this
                        .block
                        .text
                        .getStringAtPosition(this.endLocation.offset)
                }
                ...
                t.prototype.shouldPrependListItem = function () {
                    return this
                        .block
                        .isListItem() && 0 === this.startLocation.offset && !this
                        .block
                        .isEmpty()
                },
        ...
        function () {
            ...
            e.Composition = function (p) {
                ...
                d.prototype.setDocument = function (t) {
                    ...
                    return t.isEqualTo(this.document)
                        ...
                        : (
                            ...
                            this.revision++,
                            null != (e = this.delegate) && "function" == typeof e.compositionDidChangeDocument
                ...
                d.prototype.loadSnapshot = function (t) {
                    ...
                    null != (o = this.delegate) && "function" == typeof o.compositionDidLoadSnapshot
                ...
                d.prototype.insertDocument = function (t) {
                    var n,
                        i,
                        o;
                    return null == t && (t = new e.Document),
                    i = this.getSelectedRange(),
                ...
                d.prototype.insertString = function (t, n) {
                    var i,
                        o;
                    return i = this.getCurrentTextAttributes(),
                    o = e
                        .Text
                        .textForStringWithAttributes(t, i),
                    this.insertText(o, n)
                },
                ...
                d.prototype.insertAttachments = function (t) {
                    ...
                    for (c = new e.Text, r = 0, s = t.length; s > r; r++) 
                        n = t[r],
                        l = n.getType(),
                        a = null != (u = e.config.attachments[l])
                            ? u.presentation
                            : void 0,
                        ...
                        i = e
                            .Text
                            .textForAttachmentWithAttributes(n, o),
                        c = c.appendText(i);
                ...
                d.prototype.deleteInDirection = function (t, e) {
                    ...
                    o && this.canDecreaseBlockAttributeLevel() && (
                        i = this.getBlock(),
                        i.isListItem()
                        ...
                        : (
                            c && (
                                a = this.getExpandedRangeInDirection(t, {length: r}),
                                "backward" === t && (n = this.getAttachmentAtRange(a))
                            ),
                            n
                ...
                d.prototype.moveTextFromRange = function (t) {
                    var e;
                    return e = this.getSelectedRange()[0],
                ...
                d.prototype.removeLastBlockAttribute = function () {
                    var t,
                        ...
                        n,
                        i;
                    return n = this.getSelectedRange(),
                    i = n[0],
                    e = n[1],
                    t = this
                        .document
                ...
                d.prototype.insertPlaceholder = function () {
                    return this.placeholderPosition = this.getPosition(),
                    this.insertString(f)
                },
                d.prototype.selectPlaceholder = function () {
                    return null != this.placeholderPosition
                        ? (this.setSelectedRange([
                            this.placeholderPosition, this.placeholderPosition + f.length
                ...
                d.prototype.setTextAttribute = function (t, n) {
                    ...
                    if (o = this.getSelectedRange()) 
                        ...
                        i = o[1],
                        r !== i
                            ? this.setDocument(this.document.addAttributeAtRange(t, n, o))
                            : "href" === t
                                ? (s = e.Text.textForStringWithAttributes(n, {href: n}), this.insertText(s))
                                : void 0
                        },
                d.prototype.setBlockAttribute = function (t, e) {
                    ...
                    if (i = this.getSelectedRange()) 
                        return this.canSetCurrentAttribute(t)
                            ? (
                                n = this.getBlock(),
                                this.setDocument(this.document.applyBlockAttributeAtRange(t, e, i)),
                                this.setSelection(i)
                            )
                            : void 0
                    },
                ...
                d.prototype.decreaseListLevel = function () {
                    ...
                    for (
                        ...
                        (
                            e = this.document.getBlockAtIndex(
                                n + 1
                            )
                        ) && e.isListItem() && e.getAttributeLevel() > t;
                    ) 
                        n++;
                    return r = this
                        .document
                        .positionFromLocation({index: o, offset: 0}),
                    i = this
                        .document
                        .positionFromLocation({index: n, offset: 0}),
                ...
                d.prototype.updateCurrentAttributes = function () {
                    ...
                    if (s = this.getSelectedRange({
                        ...
                        if (!a(e, this.currentAttributes)) 
                            return this.currentAttributes = e,
                            this.notifyDelegateOfCurrentAttributesChange()
                    }
                },
                ...
                d.prototype.setSelection = function (t) {
                    ...
                    null != (n = this.delegate)
                        ? n.compositionDidRequestChangingSelectionToLocationRange(e)
                        : void 0
                },
                ...
                d.prototype.getLocationRange = function (t) {
                    var e,
                        n;
                    return null != (
                        e = null != (n = this.targetLocationRange)
                            ? n
                ...
                d.prototype.moveCursorInDirection = function (t) {
                    ...
                    return this.editingAttachment
                        ? i = this
                            .document
                            .getRangeOfAttachment(this.editingAttachment)
                        : (
                            o = this.getSelectedRange(),
                ...
                d.prototype.selectionIsInCursorTarget = function () {
                    return this.editingAttachment || this.positionIsCursorTarget(
                        this.getPosition()
                    )
                },
                ...
                d.prototype.refreshAttachments = function () {
                    ...
                    for (
                        ...
                        e = h[i],
                        e.delegate = null,
                        null != (u = this.delegate) && "function" == typeof u.compositionDidRemoveAttachment && u.compositionDidRemoveAttachment(
                            e
                        );
                    for (p = [], o = 0, s = t.length; s > o; o++) 
                        ...
                        e.delegate = this,
                        p.push(
                            null != (c = this.delegate) && "function" == typeof c.compositionDidAddAttachment
                ...
                d.prototype.attachmentDidChangeAttributes = function (t) {
                    ...
                    null != (e = this.delegate) && "function" == typeof e.compositionDidEditAttachment
                ...
                d.prototype.attachmentDidChangePreviewURL = function (t) {
                    var e;
                    return this.revision++,
                    null != (e = this.delegate) && "function" == typeof e.compositionDidChangeAttachmentPreviewURL
                ...
                d.prototype.editAttachment = function (t, e) {
                    ...
                    if (t !== this.editingAttachment) 
                        return this.stopEditingAttachment(),
                        this.editingAttachment = t,
                        null != (n = this.delegate) && "function" == typeof n.compositionDidStartEditingAttachment
                            ? n.compositionDidStartEditingAttachment(this.editingAttachment, e)
                            : void 0
                    },
                d.prototype.stopEditingAttachment = function () {
                    var t;
                    if (this.editingAttachment) 
                        return null != (t = this.delegate) && "function" == typeof t.compositionDidStopEditingAttachment && t.compositionDidStopEditingAttachment(
                ...
                d.prototype.notifyDelegateOfInsertionAtRange = function (t) {
                    var e;
                    return null != (e = this.delegate) && "function" == typeof e.compositionDidPerformInsertionAtRange
        ...
        function () {
            ...
            t = function () {
                ...
                var e,
                    n,
                    i;
                return e = "attachmentGallery",
                n = "presentation",
                i = "gallery",
                t.prototype.perform = function () {
                    return this.removeBlockAttribute(),
                ...
                t.prototype.removeBlockAttribute = function () {
                    ...
                    for (o = this.findRangesOfBlocks(), r = [], t = 0, n = o.length; n > t; t++) 
                        i = o[t],
                        r.push(this.document = this.document.removeAttributeAtRange(e, i));
                    return r
                },
                    ...
                    for (
                        ...
                        o[1] - o[0] > 1 && (
                            ...
                            "\n" !== this.document.getCharacterAtPosition(o[1]) && (
                                this.document = this.document.insertBlockBreakAtRange(o[1]),
                                o[1] < this.selectedRange[1] && this.moveSelectedRangeForward(),
                                o[1]++,
                                i++
                            ),
                            0 !== o[0] && "\n" !== this.document.getCharacterAtPosition(o[0] - 1) && (
                                this.document = this.document.insertBlockBreakAtRange(o[0]),
                                o[0] < this.selectedRange[0] && this.moveSelectedRangeForward(),
                                o[0]++,
                                i++
                            ),
                ...
                t.prototype.findRangesOfPieces = function () {
                    return this
                        .document
                        .findRangesForTextAttribute(n, {withValue: i})
                },
                t.prototype.moveSelectedRangeForward = function () {
                    return this.selectedRange[0] += 1,
        ...
        function () {
            ...
            e.Editor = function () {
                ...
                var i;
                return i = [e.attachmentGalleryFilter],
                ...
                n.prototype.loadHTML = function (t) {
                    return null == t && (t = ""),
                    this.loadDocument(e.Document.fromHTML(t, {referenceElement: this.element}))
                },
                ...
                n.prototype.loadSnapshot = function (t) {
                    return this.undoManager = new e.UndoManager(this.composition),
                    this
                        .composition
                        .loadSnapshot(t)
                },
        ...
        function () {
            ...
            e.ManagedAttachment = function (e) {
                ...
                n.prototype.remove = function () {
                    return this
                        .attachmentManager
                        .requestRemovalOfAttachment(this.attachment)
                },
        ...
        function () {
            ...
            e.AttachmentManager = function (n) {
                ...
                i.prototype.requestRemovalOfAttachment = function (t) {
                    var e;
                    return this.attachmentIsManaged(t) && null != (e = this.delegate) && "function" == typeof e.attachmentManagerDidRequestRemovalOfAttachment
                        ? e.attachmentManagerDidRequestRemovalOfAttachment(t)
                        : void 0
                },
                i.prototype.unmanageAttachment = function (t) {
                    var e;
                    return e = this.managedAttachments[t.id],
            ...
            e.LocationMapper = function () {
                ...
                return e.prototype.findLocationFromContainerAndOffset = function (e, i, o) {
                    ...
                    for (
                        ...
                        v = h(this.element, {usingFilter: f}); v.nextNode();
                    ) {
            ...
            e.PointMapper = function () {
                ...
                return e.prototype.createDOMRangeFromPoint = function (e) {
                    ...
                    if (c = e.x, l = e.y, document.caretPositionFromPoint) 
                        return a = document.caretPositionFromPoint(c, l),
                        r = a.offsetNode,
                        o = a.offset,
                ...
                e.prototype.getClientRectsForDOMRange = function (t) {
                    var e,
                        n,
                        o;
                    return n = i.call(t.getClientRects()),
                    o = n[0],
                    e = n[n.length - 1],
                    [o, e]
                },
        ...
        function () {
            ...
            e.SelectionChangeObserver = function (e) {
                ...
                o.prototype.update = function () {
                    ...
                    s(e, this.domRange)
                        ? void 0
                        : (this.domRange = e, this.notifySelectionManagersOfSelectionChange())
                },
            ...
            e.SelectionManager = function (d) {
                ...
                f.prototype.locationIsCursorTarget = function (t) {
                    var e,
                        n,
                        i;
                    return i = this.findNodeAndOffsetFromLocation(t),
                    e = i[0],
                    n = i[1],
                    s(e)
                },
                ...
                f.prototype.createLocationRangeFromDOMRange = function (t, e) {
                    ...
                    if (null != t && this.domRangeWithinElement(t) && (i = this.findLocationFromContainerAndOffset(t.startContainer, t.startOffset, e))) 
                        return t.collapsed || (
                            n = this.findLocationFromContainerAndOffset(t.endContainer, t.endOffset, e)
                        ),
                        a([i, n])
                },
                ...
                f.prototype.updateCurrentLocationRange = function (t) {
                    ...
                    return (
                        ...
                        ? (
                            ...
                            null != (e = this.delegate) && "function" == typeof e.locationRangeDidChange
                                ? e.locationRangeDidChange(this.currentLocationRange.slice(0))
                                : void 0
                        )
                        : void 0
                },
                f.prototype.createDOMRangeFromLocationRange = function (t) {
                    var e,
                        ...
                        i,
                        o;
                    return i = this.findContainerAndOffsetFromLocation(t[0]),
                    n = u(t)
                        ? i
                        : null != (o = this.findContainerAndOffsetFromLocation(t[1]))
                            ...
                            : i,
                    null != i && null != n
                        ? (e = document.createRange(), e.setStart.apply(e, i), e.setEnd.apply(e, n), e)
                        : void 0
                },
                f.prototype.getLocationAtPoint = function (t) {
                    var e,
                        n;
                    return (e = this.createDOMRangeFromPoint(t)) && null != (
                ...
                f.prototype.domRangeWithinElement = function (e) {
                    return e.collapsed
                        ...
                        : t(this.element, e.startContainer) && t(this.element, e.endContainer)
                },
                f
            }(e.BasicObject)
        }.call(this),
        function () {
            ...
            e.EditorController = function (s) {
                ...
                u.prototype.registerSelectionManager = function () {
                    return e
                        .selectionChangeObserver
                        .registerSelectionManager(this.selectionManager)
                },
                u.prototype.unregisterSelectionManager = function () {
                    return e
                        .selectionChangeObserver
                        .unregisterSelectionManager(this.selectionManager)
                },
                u.prototype.render = function () {
                    return this
                ...
                u.prototype.reparse = function () {
                    return this
                        .composition
                        .replaceHTML(this.editorElement.innerHTML)
                },
                u.prototype.compositionDidChangeDocument = function () {
                    return this.notifyEditorElement("document-change"),
                    this.handlingInput
                        ? void 0
                        : this.render()
                },
                u.prototype.compositionDidChangeCurrentAttributes = function (t) {
                    return this.currentAttributes = t,
                    this
                        .toolbarController
                        .updateAttributes(this.currentAttributes),
                    this.updateCurrentActions(),
                    this.notifyEditorElement(
                        "attributes-change",
                ...
                u.prototype.compositionDidAddAttachment = function (t) {
                    ...
                    return e = this
                        .attachmentManager
                        .manageAttachment(t),
                    this.notifyEditorElement("attachment-add", {attachment: e})
                },
                ...
                u.prototype.compositionDidRemoveAttachment = function (t) {
                    ...
                    this.notifyEditorElement("attachment-remove", {attachment: e})
                },
                u.prototype.compositionDidStartEditingAttachment = function (t, e) {
                    return this.attachmentLocationRange = this
                        .composition
                        .document
                    ...
                    this
                        .selectionManager
                        .setLocationRange(this.attachmentLocationRange)
                },
                ...
                u.prototype.compositionControllerDidRequestDeselectingAttachment = function (t) {
                    var e,
                        n;
                    return e = null != (n = this.attachmentLocationRange)
                        ? n
                        : this
                            .composition
                            .document
                ...
                u.prototype.inputControllerWillMoveText = function () {
                    return this
                        .editor
                        .recordUndoEntry("Move")
                },
                u.prototype.inputControllerWillAttachFiles = function () {
                    return this
                        .editor
                        .recordUndoEntry("Drop Files")
                },
                ...
                u.prototype.inputControllerDidStartDrag = function () {
                    return this.locationRangeBeforeDrag = this
                        .selectionManager
                        .getLocationRange()
                },
                ...
                u.prototype.inputControllerDidCancelDrag = function () {
                    return this
                        .selectionManager
                        .setLocationRange(this.locationRangeBeforeDrag),
                ...
                u.prototype.locationRangeDidChange = function (t) {
                    ...
                    this.updateCurrentActions(),
                    this.attachmentLocationRange && !o(this.attachmentLocationRange, t) && this
                        .composition
                ...
                u.prototype.actions = {
                    ...
                    increaseNestingLevel: {
                        ...
                        perform: function () {
                            return this
                                .editor
                                .increaseNestingLevel() && this.render()
                        }
                    },
                    decreaseNestingLevel: {
                        test: function () {
                        ...
                        perform: function () {
                            return this
                                .editor
                                .decreaseNestingLevel() && this.render()
                        }
                    },
                    attachFiles: {
                        test: function () {
                        ...
                        perform: function () {
                            return e
                                .config
                                .input
                                .pickFiles(this.editor.insertFiles)
                        }
                    }
                },
                ...
                u.prototype.updateCurrentActions = function () {
                    var t;
                    return t = this.getCurrentActions(),
                ...
                c = function (t, e) {
                    return o(t.selectedRange, e.selectedRange) && t
                        .document
                        .isEqualTo(e.document)
                },
                ...
                u.prototype.removeAttachment = function (t) {
                    return this
                        .editor
                        .recordUndoEntry("Delete Attachment"),
                    this
                        .composition
                        .removeAttachment(t),
                    this.render()
                ...
                u.prototype.getUndoContext = function () {
                    var t;
                    return t = 1 <= arguments.length
                        ? a.call(arguments, 0)
                        : [],
                    [this.getLocationContext(), this.getTimeContext()].concat(a.call(t))
                },
        ...
        function () {
            ...
            i = e.findClosestElementFromNode,
            t = e.AttachmentView.attachmentSelector,
            e.registerElement("trix-editor", function () {
                var c,
                    l,
                    h,
                    p,
                ...
                return g = 0,
                l = function (t) {
                    return !document.querySelector(":focus") && t.hasAttribute("autofocus") && document.querySelector(
                        "[autofocus]"
                    ) === t
                        ? t.focus()
                        : void 0
                ...
                m = function (t) {
                    return t.hasAttribute("contenteditable")
                        ? void 0
                        : (t.setAttribute("contenteditable", ""), r("focus", {
                            onElement: t,
                ...
                d = function (t) {
                    return (
                        ...
                        ? (document.execCommand("enableObjectResizing", !1, !1), o("mscontrolselect", {
                            onElement: t,
                            preventDefault: !0
                        }))
                        : void 0
                ...
                p = function () {
                    ...
                    defaultCSS: "%t {\n  display: block;\n}\n\n%t:empty:not(:focus)::before {\n  content: attr(" +
                            ...
                            "n: absolute;\n  left: -9999px;\n  max-height: 0px;\n}\n\n%t " + t + " figcapti" +
                            "on[data-trix-placeholder]:empty::before {\n  content: attr(data-trix-placehold" +
                            "er);\n  color: graytext;\n}\n\n%t [data-trix-cursor-target] {\n  display: " + p.display +
                            " !important;\n  width: " + p.width + " !important;\n  padding: 0 !important;\n" +
                            "  margin: 0 !important;\n  border: none !important;\n}\n\n%t [data-trix-cursor" +
                            "-target=left] {\n  vertical-align: top !important;\n  margin-left: -1px !impor" +
                            "tant;\n}\n\n%t [data-trix-cursor-target=right] {\n  vertical-align: bottom !im" +
                    ...
                    labels: {
                        get: function () {
                            var t,
                                ...
                                n;
                            return e = [],
                            this.id && this.ownerDocument && e
                                .push
                                .apply(e, this.ownerDocument.querySelectorAll("label[for='" + this.id + "']")),
                            ...
                            return this.hasAttribute("input")
                                ...
                                : this.parentNode
                                    ? (
                                        ...
                                        this.parentNode.insertBefore(t, this.nextElementSibling),
                                        t
                                    )
                                    : void 0
                        }
                    ...
                    disconnect: function () {
                        var t;
                        return null != (t = this.editorController) && t.unregisterSelectionManager(),
                        this.unregisterResetListener(),
                        this.unregisterClickListener()
                    },
                    registerResetListener: function () {
                        return this.resetListener = this
                            .resetBubbled
                            .bind(this),
                    ...
                    registerClickListener: function () {
                        return this.clickListener = this
                            .clickBubbled
                            .bind(this),
                    ...
                    resetBubbled: function (t) {
                        var e;
                        if (!t.defaultPrevented && t.target === (
                            null != (e = this.inputElement)
                                ? e.form
                                : void 0
                        )) 
                            return this.reset()
                    ...
                    clickBubbled: function (t) {
                        var e;
                        if (!(t.defaultPrevented || this.contains(t.target) || !(e = i(t.target, {matchingSelector: "label"})) || u.call(this.labels, e) < 0)) 
                            return this.focus()
                    },
                    reset: function () {
